...
export function ChangelogUpdate() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      shouldOpen = dismissedRelease !== release && seenRelease !== release;
    } catch {
      shouldOpen = true;
    }
  ...
  function dismissFutureVisits() {
    try {
      window.localStorage.setItem(dismissedReleaseKey, release);
      window.sessionStorage.setItem(seenReleaseKey, release);
    } catch {
      // The announcement can still close when browser storage is unavailable.
    }
        ...
        <div className="changelog-body">
          ...
          <dl className="changelog-list">
            ...
            <div>
              ...
              <div>
                <dt>New work</dt>
                <dd>ASCII Image, Ripple Transition, Matrix Rain, and more.</dd>
              </div>
            </div>
          </dl>

          <div className="changelog-actions">
            <button type="button" onClick={dismissFutureVisits}>
              Hide this release
            </button>
